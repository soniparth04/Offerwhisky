    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="space-y-6 max-w-md mx-auto">
          ...
          {/* Video Ad Option */}
          <div
            className="bg-purple-50 p-6 rounded-xl border border-purple-100 hover:shadow-md transition-all cursor-pointer" onClick={() => navigate(`/shop-owner/Create-ads-video`)}
          >
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center mr-4 shadow-sm" 
              >
