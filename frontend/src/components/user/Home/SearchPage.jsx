...
const mockProducts = [
  ...
  },
  {
    ...
    reviews: 87,
    image:
      "https://images.unsplash.com/photo-1544441893-675973e31985?w=300&h=300&fit=crop&crop=center",
    category: "Fashion",
    brand: "TrendyWear",
  },
];
        ...
        <div className="px-4 py-3">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div className="flex-1 relative">
              <div className="flex items-center border border-gray-300 rounded-full px-4 py-3 bg-white transition-all duration-200">
            ...
            <div className="grid grid-cols-2 gap-3">
              {popularSearches.map((term, index) => (
                <button
                  ...
                  className="flex items-center space-x-3 p-4 bg-white rounded-xl border hover:border-blue-300 hover:bg-purple-50 transition-all duration-200 text-left group"
                >
                  <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-purple-200 transition-colors">
